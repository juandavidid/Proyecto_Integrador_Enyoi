...
const Featured = () => {
    const { data, loading, error } = useFetch("/api/hotels/countByCity?cities=berlin,madrid,london")  //    /hotels/countByCity?cities=berlin,madrid,london  'http://localhost:8800/api/hotels/countByCity?cities=berlin,madrid,london'
    console.log(loading)

    return (
        <div className="featured">

            {/* Expresion  condicional   sintaxis  { trur ? (condicion 1): (<> condicion 2 </> )}  */}
                ...
                (<>
                    ...
                    <div className="featuredItem">
                        ...
                        <div className="featuredTitles">
                            ...
                            {/*Interpolacion de Valores  valor= 1   --> {valor} */}
